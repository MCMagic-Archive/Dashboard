...
import us.mcmagic.dashboard.packets.dashboard.PacketMyMCMagicRegister;
...
public class Commandpin extends MagicCommand {
    ...
    public void execute(final Player player, String label, String[] args) {
        ...
        if ((r.getRankId() < Rank.EARNINGMYEARS.getRankId()) && (r.getRankId() >= Rank.SHAREHOLDER.getRankId())
                && curt < 1477335600) {
