...
import us.mcmagic.dashboard.handlers.Server;
import us.mcmagic.dashboard.packets.dashboard.PacketConnectionType;
import us.mcmagic.dashboard.packets.dashboard.PacketOnlineCount;
import us.mcmagic.dashboard.packets.dashboard.PacketSendToServer;
import us.mcmagic.dashboard.packets.dashboard.PacketTargetLobby;
...
public class ServerUtil {
    ...
    private void loadServers() {
        ...
        try (Connection connection = Dashboard.sqlUtil.getConnection()) {
            PreparedStatement sql = connection.prepareStatement("SELECT name,address,port,park,type FROM servers;");
